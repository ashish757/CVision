    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="ml-64 p-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-text">Hello {user?.name || "User"}!</h1>
        ...
        <div className="flex items-center space-x-4 mb-8">
          <button className="bg-primary hover:bg-primary/90 text-background px-6 py-3 rounded-lg font-medium transition-colors flex items-center space-x-2">
            ...
            <span>Star New Analysis</span>
          </button>

          <button className="bg-primary hover:bg-secondary/90 text-background px-6 py-3 rounded-lg font-medium transition-colors flex items-center space-x-2">
